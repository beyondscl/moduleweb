...
<head>
    ...
    <script type="text/javascript" charset="utf-8"
            src="${basePath}/article/ueditor.all.min.js"></script>
    <!--建议手动加在语言，避免在ie下有时因为加载语言失败导致编辑器加载失败-->
    <!--这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->
    <script type="text/javascript" charset="utf-8"
            src="${basePath}/article/lang/zh-cn/zh-cn.js"></script>
...
<form action="/articleAction/save" method="post"
    ...
    <div>
        ...
        <div name="content" id="editor" style="width:80%;height:200px;"/>
    </div>
    <div>
        <div>
            <label>分类</label>
        ...
        <div>
            <label>关键字</label>
            <input name="keyWords" value="java 源码分析"/>
        </div>
        <div>
            <label>权限</label>
